...
},{"rx":28}],2:[function(require,module,exports){
"use strict";
 ...
 */
},{"./mock-dom-source":4,"./render-dom":5,"./render-html":6,"./virtual-hyperscript":9,"./virtual-hyperscript-svg":8,"hyperscript-helpers":17}],3:[function(require,module,exports){
"use strict";
...
},{"rx":28}],5:[function(require,module,exports){
"use strict";
...
},{"./fromevent":3,"./transposition":7,"./virtual-hyperscript":9,"matches-selector":26,"rx":28,"vdom-parser":33,"virtual-dom/diff":40,"virtual-dom/patch":41}],6:[function(require,module,exports){
"use strict";
...
},{"./transposition":7,"rx":28,"vdom-to-html":37}],7:[function(require,module,exports){
"use strict";
...
},{"rx":28,"virtual-dom/vnode/vnode":60}],8:[function(require,module,exports){
/*eslint-disable */
'use strict';
...
// END Cycle.js-specific code <<<<<<<<<<
},{"./virtual-hyperscript":9,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":48,"virtual-dom/virtual-hyperscript/svg-attribute-namespace":52,"x-is-array":65}],9:[function(require,module,exports){
/* eslint-disable */
'use strict';
...
/* eslint-enable */
},{"virtual-dom/virtual-hyperscript/hooks/ev-hook.js":49,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook.js":50,"virtual-dom/virtual-hyperscript/parse-tag.js":51,"virtual-dom/vnode/is-thunk":54,"virtual-dom/vnode/is-vhook":55,"virtual-dom/vnode/is-vnode":56,"virtual-dom/vnode/is-vtext":57,"virtual-dom/vnode/is-widget":58,"virtual-dom/vnode/vnode.js":60,"virtual-dom/vnode/vtext.js":62,"x-is-array":65}],10:[function(require,module,exports){
"use strict";
...
},{"jsonp":21,"rx":28}],11:[function(require,module,exports){
...
},{"./vendor/camel-case-regexp":30,"./vendor/non-word-regexp":31,"./vendor/trailing-digit-regexp":32,"lower-case":25}],30:[function(require,module,exports){
...
},{"./property-config":38,"escape-html":14}],37:[function(require,module,exports){
var escape = require('escape-html');
...
},{"../vnode/is-vhook.js":55,"is-object":20}],43:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":53,"../vnode/is-vnode.js":56,"../vnode/is-vtext.js":57,"../vnode/is-widget.js":58,"./apply-properties":42,"global/document":16}],44:[function(require,module,exports){
...
},{"./create-element":43,"./dom-index":44,"./patch-op":45,"global/document":16,"x-is-array":65}],47:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"ev-store":15}],50:[function(require,module,exports){
'use strict';
...
},{"browser-split":12}],52:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-vhook":55,"is-object":20}],64:[function(require,module,exports){
var isArray = require("x-is-array")
...
function searchBox(responses) {
  var apiUrl$ = responses.props$.map(function (props) {
    return props['apiUrl'];
  }).first();

  var vtree$ = _rx2.default.Observable.just((0, _dom.h)('div', { className: 'search' }, [(0, _dom.h)('input', {
...
},{"@cycle/core":1,"@cycle/dom":2,"rx":28}],68:[function(require,module,exports){
'use strict';
...
var _jsonp = require('@cycle/jsonp');
...
var API_URL = 'https://en.wikipedia.org/w/api.php?action=query&list=search&format=json&srsearch=';

function main(responses) {
  var wpSearchBox = (0, _search2.default)({
    DOM: responses.DOM,
    props$: _rx2.default.Observable.just({
      apiUrl: API_URL
    })
  });
  ...
  }).concatAll().pluck('query', 'search').startWith([]);

  return {
    JSONP: wpSearchBox.JSONPQuery,
    DOM: _rx2.default.Observable.combineLatest(searchDOM$, searchResults$, function (tree, results) {
...
_core2.default.run(main, {
  ...
  JSONP: (0, _jsonp.makeJSONPDriver)()
});

},{"./search":67,"@cycle/core":1,"@cycle/dom":2,"@cycle/jsonp":10,"rx":28}]},{},[68]);
