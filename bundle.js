...
function main(responses) {
  var vtree$ = responses.JSONP.filter(function (res$) {
    return res$.request.indexOf(API_URL) === 0;
  }).mergeAll().pluck('query', 'search').startWith([]).map(vtreeElements);
 ...
 */
},{"./mock-dom-source":5,"./render-dom":6,"./render-html":7,"./virtual-hyperscript":10,"./virtual-hyperscript-svg":9,"hyperscript-helpers":18}],4:[function(require,module,exports){
"use strict";
...
},{"./fromevent":4,"./transposition":8,"./virtual-hyperscript":10,"matches-selector":27,"rx":29,"vdom-parser":34,"virtual-dom/diff":41,"virtual-dom/patch":42}],7:[function(require,module,exports){
"use strict";
...
},{"jsonp":22,"rx":29}],12:[function(require,module,exports){
